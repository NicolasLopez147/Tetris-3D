...
class Render{
    ...
    public:
        ...
        void render(const glm::mat4& projection, const glm::mat4& view, int score, int level, int linesCleared) {
            ...
            textShader.renderText(textShader, levelText, 1200.0f, 1000.0f, 1.0f, glm::vec3(0.5, 0.8f, 0.2f));
            textShader.renderText(textShader, scoreText, 1200.0f, 1100.0f, 1.0f, glm::vec3(0.8f, 0.2f, 0.2f));
